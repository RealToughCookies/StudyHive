...
try {
  const entries = ['tests/regressions.test.tsx', 'tests/audit.test.tsx', 'tests/cloud.test.tsx', 'tests/auth.test.tsx', 'tests/pro.test.tsx', 'tests/billing.test.tsx', 'tests/pro-request.test.tsx', 'tests/export.test.tsx', 'tests/deletion.test.tsx']
  await build({
